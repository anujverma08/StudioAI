...
import { generateArticle, generateBlogTitle, generateImage, removeImageBackground } from '../controllers/aiController.js'; // Added .js extension
...
aiRouter.post('/review-resume', upload.single('resume'), auth, reviewResume); // Added route for reviewing resume
