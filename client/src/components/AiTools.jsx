    ...
    <div className='px-4 sm:px-20 xl:px-32 my-24'>
        ...
        <div className='flex flex-wrap m-10 justify-center'>
            {AiToolsData.map((tool,index)=>{
                return(
                <div key={index} className='p-8 m-4 max-w-xs rounded-lg bg-[#FDFDFE] shadow-kg border border-gray-100 hover:-translate-y-1 transition-all duration-300 cursor-pointer' onClick={() =>
